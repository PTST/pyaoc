...
class Computer:
    ...
    def instruction(self):
        ...
        parameter_modes = [
            ParameterMode(int(x)) for x in str(instruction).zfill(5)[::-1][2:]
        ]
    ...
    def compute_cycle(self):
        ...
        match op_code:
            case 1:
                self.add(
                    self.get(self.instruction_pointer + 1, parameters[0]),
                    self.get(self.instruction_pointer + 2, parameters[1]),
                    self.get_store_index(self.instruction_pointer + 3, parameters[2]),
                )
            ...
            case 3:
                self.input(
                    self.get_store_index(self.instruction_pointer + 1, parameters[0])
                )
